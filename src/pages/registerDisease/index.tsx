...
import PatologiaCard from '../../components/Admin/registerDisease/PatologiaCard'
...
const RegisterDisease = () => {
  ...
  function createSymptomData(event: FormEvent) {
    ...
    db.set(db.ref(db.database, `sintomas/${newKey}`), { nomeSintoma })
    toast({
  ...
  function createPathologyData(event: FormEvent) {
    ...
    toast({
      ...
      description: 'A patologia foi criada no banco de dados com sucesso.',
      status: 'success',
      duration: 4000,
      isClosable: true
    })
  ...
  function updateDiseaseData() {
    ...
    db.update(db.ref(db.database, `patologias/${dados.chave}`), dados)
    setPatologiaData(emptyPatologiaData)
    uncheckAll()
    setModificando(false)
    toast({
      title: 'Patologia editada',
      description: 'A patologia foi editada no banco de dados com sucesso.',
      status: 'success',
      duration: 4000,
      isClosable: true
    })
  ...
  function deleteSymptomData(key: string) {
    db.remove(db.ref(db.database, `sintomas/${key}`))
  ...
  function deleteDiseaseData(key: string | null) {
    db.remove(db.ref(db.database, `patologias/${key}`))
  ...
  const [defaultKeySymptomsSelecionados, setDefaultKeySymptomsSelecionados] =
    useState([''])
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      <Card marginTop={'2'} bg={'lightgray'}>
                        <CardBody>
                          ...
                          >
                            ...
                            >
                              ...
                              <Checkbox
                                ...
                                colorScheme="green"
                                isChecked={
                                  patologiaData.prevalencia.animal.gato
                                }
                                onChange={(e) => {
                                  setPatologiaData({
                                    ...patologiaData,
                          ...
                          <ButtonGroup marginTop={'10px'}>
                            <Button textColor={'white'} onClick={checkAll}>
                              Marcar Tudo
                            </Button>
                            <Button textColor={'white'} onClick={uncheckAll}>
                              Desmarcar Tudo
                            </Button>
                          </ButtonGroup>
                        </CardBody>
                      ...
                      />
                      <Card marginTop={'5px'} backgroundColor={'whitesmoke'}>
                        <CardHeader>
                  ...
                  >
                    ...
                    >
                      {estaBuscando
                        ? buscaPatologia?.map((patologia) => {
                            return (
                              <div
                                key={patologia.chave}
                                // className={styles.symptomUnchecked}
                              >
                                <Text>
                                  ...
                                  <EditIcon
                                    marginLeft={'2px'}
                                    marginRight={'4px'}
                                    onClick={() => editDiseaseData(patologia)}
                                  />
                                  <DeleteIcon
                                    cursor={'pointer'}
                                    onClick={() =>
                                      deleteDiseaseData(patologia.chave)
                                    }
                                  />
                                </Text>
                              </div>
                  ...
                  >
                    <FormControl paddingLeft={'5px'}>
                      ...
                      <Input
                        ...
                        value={nomeSintoma}
                        required
                        onChange={(event) => setNomeSintoma(event.target.value)}
                      />
                      <Button
                        colorScheme="teal"
                        margin={'10px 50px'}
                              ...
                              >
                                <Text>
                                  ...
                                  <DeleteIcon
                                    cursor={'pointer'}
                                    onClick={() =>
                                      deleteSymptomData(sintoma.chave)
                                    }
                                  />
                                </Text>
                              </div>
